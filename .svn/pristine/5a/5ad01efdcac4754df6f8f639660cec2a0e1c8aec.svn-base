...
public class CreatePurchaseInAsnBillHttpClientTest {
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	private String token = "YWRtaW5fMTdiYzU4YWY5ZWU4NGMwZjhjYWE1MjY5ZTgzMTYzOTdfemhJUDJmZVpsVUVFc2xGbEcwNGFoZz09";
	@Test
	public void createPurchaseInAsnBill() {
		String httpURL = "http://localhost:11000/spi/e3/completionOrder/push/createPurchaseInAsnBill";
		...
		String supplierCode = "SXTY";
		String wareHouseCode = "357183";
		String sourceBillNo = "WGD20181211007"; // 完工单号
		List<Map<String,Object>> transData = new ArrayList<Map<String,Object>>();
		Map<String,Object> details = new HashMap<String,Object>();
		details.put("singleProCode", "YX162B11900001");
		details.put("goodsCode", "YX162B119");
		details.put("whareaTypeCode", "000");
		details.put("quantity", 60);
		details.put("price1", 666);
		transData.add(details);
		param.put("token", token);
		param.put("billDate", billDate);
		param.put("supplierCode", supplierCode);
		param.put("wareHouseCode", wareHouseCode);
		param.put("sourceBillNo", sourceBillNo);
